...
static void test_list_get_value(void) {
    list lst = List.new(5, sizeof(addr));
    Person *expPerson = malloc(sizeof(Person));
    expPerson->id = 1;
...
static void test_list_remove_at(void) {
    ...
    Assert.areEqual(&(int){-1}, &result, INT, "List get should ERR after remove at index %d",
                    index);
...
static void test_list_set_value(void) {
    list lst = List.new(5, sizeof(addr));
    Person *expP1 = malloc(sizeof(Person));
    expP1->id = 1;
    strcpy(expP1->name, "Alice");
    expP1->age = 30;
    Person *expP2 = malloc(sizeof(Person));
    expP2->id = 2;
...
static void test_list_prepend_value(void) {
    ...
    strcpy(expP2->name, "Bob");
    expP2->age = 25;
    Person *expP3 = malloc(sizeof(Person));
    expP3->id = 3;
    strcpy(expP3->name, "Charlie");
    expP3->age = 28;
    Person *expP4 = malloc(sizeof(Person));
    expP4->id = 4;
    strcpy(expP4->name, "Diana");
    expP4->age = 32;
    Person *expP5 = malloc(sizeof(Person));
    expP5->id = 5;
...
static void test_list_growth(void) {
    ...
    Person *expP6 = malloc(sizeof(Person));
    expP6->id = 6;
...
static void test_list_add_all(void) { Assert.skip("Not implemented; low priority"); }
static void test_list_add_from_array(void) { Assert.skip("Not implemented; low priority"); }
...
static void test_list_set_empty_list(void) {
    ...
    Assert.areEqual(&(int){-1}, &result, INT,
                    "List set should ERR for negative index on empty list");
...
static void test_list_get_empty_list(void) {
    ...
    result = List.get(lst, -1, &retrieved);
    Assert.areEqual(&(int){-1}, &result, INT,
                    "List get should ERR for negative index on empty list");
...
static void test_list_remove_empty_list(void) {
    ...
    result = List.remove(lst, -1);
    Assert.areEqual(&(int){-1}, &result, INT,
                    "List remove should ERR for negative index on empty list");
